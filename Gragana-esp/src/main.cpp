...
// https://polyacid-bars.000webhostapp.com/Dash/php_insert.php?nodeId=node_1&arrivalTime=2022-11-21%2010:25:01&temperature=42&humidity=28
...
void loop()
{
  ...
  if (buttonState == LOW)
  {
    ...
    if (WiFi.status() == WL_CONNECTED)
    {
      ...
      String fullUrl_insert = url1 + "nodeId=node-1" + "&arrivalTime=" + timeST + "&Temp=" + tempC + "&Hum=" + humi; // preparing the full URL
      // https://polyacid-bars.000webhostapp.com/Dash/php_insert.php?nodeId=node_1&arrivalTime=2022-11-21%2010:25:01&temperature=42&humidity=28
